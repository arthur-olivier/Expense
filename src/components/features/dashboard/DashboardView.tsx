...
// Vue présentation du tableau de bord, partagée entre la page serveur (prod) et le
// loader client (démo). Ne fait aucun accès données : elle reçoit tout via `data`.
export default function DashboardView({ data }: { data: DashboardData }) {
  ...
  return (
    <div>
      {/* En-tête : titre + bandeau du mois courant (décoratif) */}
